    ...
    <div>
      ...
      <form method="post">
        <div class="row">
          ...
          <div class="col-sm-2 "> 
            <span class="cursor" onclick="document.getElementById('addroom_modal').style.display='block'">
      ...
      <div class="row">
        ...
        <div class="col-sm-2" >
          <span class="cursor" onclick="document.getElementById('editroom_modal').style.display='block'">
          <i class='material-icons'>edit</i> Edit Room</span>
          </div>
      </div>
      <br>
