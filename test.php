...
<body class="w3-light-grey">
 <?php
  ...
  $sql = "SELECT DISTINCT A.booking_id FROM guests A, booked B WHERE A.checkin>DATE_FORMAT(now(),'%Y%c%d') AND A.room_id!=-1 AND A.booking_id=B.booking_id"; // and booked_by=user_id;
